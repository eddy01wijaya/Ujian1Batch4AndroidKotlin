...
class ListDetailFragment : Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            article = it.getParcelable("param1")!!
        }
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if(article != null) {
           ...
           //tambahkan sisanya disini
            view.findViewById<TextView>(R.id.articleDetailTitle)
                .setText(article.title)
            view.findViewById<TextView>(R.id.articleDetailOverview)
                .setText(article.overview)
            view.findViewById<TextView>(R.id.articleDetailDescription)
